...
Description: the program will read csv file and convet the columns with dates expressed in military time to standard time:
			 ...
			 the output will contain both time formats(the military time and the standard time);
...
with open('E://_Python_Projects/GitHub_Random_Projects/Data_Files/NYC_TripData_2019_11_Sample.csv','r') as file: # open the file with initial data and read from it, then close the file 

	with open('E://_Python_Projects/GitHub_Random_Projects/Data_Files/NYC_TripData_Military_and_Standard_Time_Output.csv','w') as new_file: # create the file for the output and write to it, then close the file
		print()
		...
		for line in file:
			...
			def create_new_time_str(line_list): #create the function to keep both the military and the standard time

				line_list.insert(2,new_a) #insert into the list
				line_list.insert(4,new_b) #insert into the list
				return line_list
			
			line_list=create_new_time_str(line_list) # call the function
			new_str=','.join(line_list)
			#print(new_str,end='')
			
			new_file.write(new_str) #write new string to a file
			
with open('E://_Python_Projects/GitHub_Random_Projects/Data_Files/NYC_TripData_2019_11_Sample.csv','r') as file: # read the initial file
	text=file.read()
	print(text,end='')
	
print()
with open('E://_Python_Projects/GitHub_Random_Projects/Data_Files/NYC_TripData_Military_and_Standard_Time_Output.csv','r') as new_file: # read the output data
